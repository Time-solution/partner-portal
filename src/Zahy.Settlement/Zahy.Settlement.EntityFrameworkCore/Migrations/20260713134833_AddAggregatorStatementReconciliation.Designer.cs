...
namespace Zahy.Settlement.EntityFrameworkCore.Migrations
{
    ...
    [Migration("20260713134833_AddAggregatorStatementReconciliation")]
    partial class AddAggregatorStatementReconciliation
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Zahy.Settlement.AggregatorStatement", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<decimal>("DeclaredFees")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal>("DeclaredGross")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal>("DeclaredNet")
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.Property<string>("ImportIdempotencyKey")
                        .IsRequired()
                        .HasMaxLength(128)
                        .HasColumnType("nvarchar(128)");
                    ...
                    b.HasIndex("ImportIdempotencyKey")
                        .IsUnique();

                    b.HasIndex("PartnerId", "PeriodFrom", "PeriodTo");

                    b.ToTable("StlAggregatorStatements", (string)null);
                });

            modelBuilder.Entity("Zahy.Settlement.AggregatorStatementException", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("StlAggregatorStatementExceptions", (string)null);
                });

            modelBuilder.Entity("Zahy.Settlement.AggregatorStatementLine", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");

                    b.Property<decimal>("AggregatorFee")
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.HasIndex("StatementId", "ExternalOrderRef");

                    b.ToTable("StlAggregatorStatementLines", (string)null);
                });
            ...
            modelBuilder.Entity("Zahy.Settlement.PartnerLedgerAccount", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("PayableCode")
                        .IsUnique();

                    b.HasIndex("ReceivableCode")
                        .IsUnique();

                    b.ToTable("StlPartnerLedgerAccounts", (string)null);
                });
