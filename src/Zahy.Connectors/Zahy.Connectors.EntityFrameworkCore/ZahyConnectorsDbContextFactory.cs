...
public class ZahyConnectorsDbContextFactory : IDesignTimeDbContextFactory<ZahyConnectorsDbContext>
{
    public ZahyConnectorsDbContext CreateDbContext(string[] args)
    {
        var configuration = BuildConfiguration();

        var builder = new DbContextOptionsBuilder<ZahyConnectorsDbContext>()
            .UseSqlServer(configuration.GetConnectionString("Default"));

        return new ZahyConnectorsDbContext(builder.Options);
    }
