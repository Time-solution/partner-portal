...
namespace Zahy.Identity.EntityFrameworkCore.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExtraData = table.Column<string>(type: "nvarchar(2048)", maxLength: 2048, nullable: true),
                    ExtraProperties = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ConcurrencyStamp = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: false),
                    CreationTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatorId = table.Column<Guid>(type: "uniqueidentifier", nullable: true)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ZahyAdminAuditLogs", x => x.Id);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ZahyAdminAuditLogs_TenantId_CreationTime",
                table: "ZahyAdminAuditLogs",
