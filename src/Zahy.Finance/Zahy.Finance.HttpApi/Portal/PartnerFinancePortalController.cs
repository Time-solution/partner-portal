...
public class PartnerFinancePortalController : AbpControllerBase
{
    private readonly IFinancePartnerPortalAppService _portalAppService;

    public PartnerFinancePortalController(IFinancePartnerPortalAppService portalAppService)
    {
