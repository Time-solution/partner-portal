...
public class ZahyFinanceDbContextFactory : IDesignTimeDbContextFactory<ZahyFinanceDbContext>
{
    public ZahyFinanceDbContext CreateDbContext(string[] args)
    {
        var configuration = BuildConfiguration();

        var builder = new DbContextOptionsBuilder<ZahyFinanceDbContext>()
            .UseSqlServer(configuration.GetConnectionString("Default"));

        return new ZahyFinanceDbContext(builder.Options);
    }
