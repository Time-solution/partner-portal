...
public class ZahyOrderLedgerDbContextFactory : IDesignTimeDbContextFactory<ZahyOrderLedgerDbContext>
{
    public ZahyOrderLedgerDbContext CreateDbContext(string[] args)
    {
        var configuration = BuildConfiguration();

        var builder = new DbContextOptionsBuilder<ZahyOrderLedgerDbContext>()
            .UseSqlServer(configuration.GetConnectionString("Default"));

        return new ZahyOrderLedgerDbContext(builder.Options);
    }
